...
![electronBuilder配置](./electronBuilder-config.png)
...
![0.1.0版本打包成功](./0.1.0-packed.png)

![0.1.0版本打包成功2](./0.1.0-packed2.png)

双击打开应用

![双击打开应用](./dblclick.png)

![双击打开应用2](./dblclick2.png)

![双击打开应用3](./dblclick3.png)
